...
> = {
  ar: {
    ...
    company: "الشركة",
    type: "نوع العمل",
    typeValue: "معمل مفروشات، صالة عرض، وتصميم داخلي",
    location: "الموقع",
  ...
  en: {
    ...
    company: "Company",
    type: "Business type",
    typeValue: "Furniture factory, showroom & interior design studio",
    location: "Location",
  ...
  fr: {
    ...
    typeValue: "Usine de meubles, showroom & studio de design d'intérieur",
    location: "Adresse",
